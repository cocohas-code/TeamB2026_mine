...
public class Rope : MonoBehaviour
{
    ...
    [SerializeField] Vector3 startLockPosition = Vector3.zero;
    [SerializeField] bool lockStart = true;
    [SerializeField] Vector3 endLockPosition = Vector3.zero;
    [SerializeField] bool lockEnd = false;
    ...
    void Awake()
    {
        ...
        isStartLocked = lockStart;
        isEndLocked = lockEnd;

        startLock = lockStart ? startLockPosition : transform.position;
        endLock = lockEnd ? endLockPosition : currentNodePositions[totalNodes - 1];
